...
let
  ohmyzsh = pkgs.fetchFromGitHub {
    owner = "ohmyzsh";
    repo = "ohmyzsh";
    rev = "df34d2b8d575777465aed8ae9b7cd90d63fdcd6e"; # master
    sha256 = "02kyfwmjmk7f0bvz7vqnkgi6kfbrvmwg4bji7jzfaim7ng0fyw3m";
    ...
    plugins = [
      ...
      }
      {
        ...
        src = pkgs.fetchFromGitHub {
          owner = "jonmosco";
          repo = "kube-ps1";
          rev = "52bd1ecf61a9640e743281efe3a66330e64b3574"; # master
          sha256 = "1i52szmpc7iw2817r9kaqp7szk6766cy9jzfinghpas7ffkvln7a";
        };
        file = "kube-ps1.sh";
      }
    ];
